...
model.inits <- list(list(tau=2, beta0=1, beta1 = 1,beta2 = 1,b0 = c(rep(1,times = 20)) ),
                    list(tau=20, beta0=10, beta1 = 10,beta2 = 10, b0 =  rnorm(20,0,30) ),
                    list(tau=15, beta0=20, beta1 = -10,beta2 = -15, b0 =  runif(20,0,10)  )
)
...
lognorm_rand_cens_rep_student_t <- run.jags(model = model.function,
                    monitor = parameters, data = model.data,
                    inits = model.inits, burnin = 2000,
                    sample = 5000, thin = 1, n.chains = 3)
lognorm_rand_cens_mcmc_rep_student_t <- as.mcmc.list(lognorm_rand_cens_rep_student_t)
